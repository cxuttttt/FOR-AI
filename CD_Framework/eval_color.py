        ...
        for i, (batch_img1, batch_img2, batch_label1, batch_label2, name) in enumerate(eval_tbar):
            ...
            for j, (cd_pred, label) in enumerate(zip(cd_preds, labels)):
                ...
                if(count == 0):
                    ...
                    #cv2.imwrite("pics_DIFF/"+name, cd_pred)
                    ...
                    cv2.imwrite("pics_SYSU/"+name, img_colour.astype(np.uint8))
...
#LEVIR-3	WHU-31	S2-33
    ...
    parser.add_argument("--dataset-dir", type=str, default="/mnt/Disk1/liyemei/change_detection/Mei_CDNet/CDData/SYSU-CD/")
