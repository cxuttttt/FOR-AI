...
class HistMatch(object):
    """Convert ndarrays in sample to Tensors."""
    def __init__(self):
        self.val_avg_img1_hist = self.get_all_image_hist("/mnt/Disk1/BCD_Dataset/LEVIR-CD/val/A")
        self.val_avg_img2_hist = self.get_all_image_hist("/mnt/Disk1/BCD_Dataset/LEVIR-CD/val/B")
